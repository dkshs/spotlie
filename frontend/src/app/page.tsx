...
export default async function HomePage() {
  ...
  // const artists = await serverFetcher("/artists");
  ...
  return (
    <div className="my-8 flex flex-col gap-8">
      <section className="px-4 md:px-9">
        ...
        <div className="flex w-full max-w-[calc(100vw-20px)] snap-x snap-mandatory gap-2 overflow-x-auto px-1 py-3 md:gap-4">
          {musics.map((music) => (
      ...
      <section className="px-9">
        ...
        <div className="flex w-[calc(100%-20px)] flex-1 snap-x snap-mandatory gap-8 overflow-x-auto px-1 pb-3"></div>
      </section>
    </div>
  );
}
